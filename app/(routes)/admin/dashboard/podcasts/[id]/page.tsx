...
export default function EditPodcast({params}: {params: Promise<{ id: string }>}) {
  const { id } = use(params);
  ...
  useEffect(() => {
    const loadPodcast = async () => {
      try {
        ...
        // Mettre à jour le formulaire avec les données du podcast
        form.reset({
          title: podcast.title,
  ...
  const onSubmit = async (values: PodcastFormValues) => {
    ...
    try {
      ...
      toast.error("Erreur lors de la mise à jour du podcast");
    } finally {
      ...
      <div className="container mx-auto py-10 px-4 md:px-6 bg-gradient-to-b from-emerald-50 to-white min-h-screen">
        <div className="flex items-center justify-center h-64">
          <div className="flex items-center space-x-4">
            ...
            <span className="text-emerald-700 font-medium">Chargement...</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="container mx-auto py-10 px-4 md:px-6 bg-gradient-to-b from-emerald-50 to-white min-h-screen">
      ...
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-emerald-800 mb-2">Modifier le Podcast</h1>
        <p className="text-emerald-600">Modifiez les informations de votre podcast</p>
      </div>
      ...
      <Card className="border-none shadow-lg bg-white overflow-hidden">
        <CardHeader className="bg-emerald-700 text-white px-6 py-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <CardTitle className="text-2xl font-bold">Modifier le podcast</CardTitle>
              <p className="text-emerald-100 mt-1">
                Mettez à jour les informations de votre podcast
              </p>
            </div>
          </div>
        </CardHeader>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <ImageUpload
                        ...
                        type="podcast"
                        id={id} // Utiliser l'ID réel du podcast
